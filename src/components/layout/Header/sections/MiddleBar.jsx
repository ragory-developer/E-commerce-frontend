...
import { GitCompare, Heart, Menu, Search, ShoppingCart } from 'lucide-react';
function MiddleBar() {
  return (
        ...
        <div className='col-span-8'>
          <div className='flex items-center w-full max-w-4xl mx-auto'>
            <div className='relative flex-1'>
              <div className='flex items-center border border-gray-300 rounded-sm overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200'>
