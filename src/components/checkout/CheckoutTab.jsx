...
import MyCart from './TabContents/MyCart';
import Checkout from './TabContents/Checkout';
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 py-6">
      {tabs.map((tab, index) => (
        <button
          key={tab}
          className={`w-full sm:w-[280px] lg:w-[300px] h-[50px] sm:h-[55px] font-medium rounded-md transition ${index === activeTab
