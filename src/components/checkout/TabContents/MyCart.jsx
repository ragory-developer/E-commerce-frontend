...
import { ShoppingCart, X, Plus, Package } from "lucide-react";

// --- CartItem Component (unchanged, but optional improvements) ---
          ...
          <thead className="bg-gray-100">
            <tr>
              {[
                ...
                <th
                  key={head}
                  className="p-3 sm:p-4 font-semibold text-gray-700 text-xs sm:text-sm">
                  {head}
                </th>
              ))}
            </tr>
      ...
      <div className="w-full lg:w-[380px] lg:shrink-0">
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 border border-gray-200 rounded-lg h-fit sticky top-4">
          ...
          <button
            ...
            <ShoppingCart size={24} /> <span>Checkout</span>
          </button>
        </div>
      </div>
    </div>
